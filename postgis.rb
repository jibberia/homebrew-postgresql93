class Postgis < Formula
  ...
  def install
    ...
    args = [
      ...
      "--with-pgconfig=#{Formula["postgresql93"].opt_bin}/pg_config",
    ...
    (doc/"postgresql93/extension").install Dir["stage/**/share/doc/postgresql93/extension/*"]
    (share/"postgresql93/extension").install Dir["stage/**/share/postgresql93/extension/*"]
  ...
  def caveats
    <<-EOS.undent
      ...
      PostGIS extension modules installed to:
        #{HOMEBREW_PREFIX}/share/postgresql93/extension
      EOS
  end
